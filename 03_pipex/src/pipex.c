...
/*   Updated: 2023/04/07 12:09:27 by abeaugra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex.h"

/* Le programme prend en charge les entrées et sorties
** de fichiers,les redirections, les commandes séparées par des pipes, 
** et l'option "here_doc". 
...
/* child: Cette fonction est exécutée par un processus enfant. Redirige les 
...
** Elle appelle ensuite la fonction parent pour attendre que tous les enfants 
** se terminent.*/
...
/* Cette fonction est le point d'entrée du programme. Elle vérifie 
** les arguments les variables d'environnement, initialise la 
** structure de données t_data, et appelle la fonction pipex*/
